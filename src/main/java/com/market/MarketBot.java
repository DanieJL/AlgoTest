...
public class MarketBot {
    ...
    public String findNew(KlineDatapack klineData) {
        ...
        return switch (algoName) {
            ...
            case "MACD_RSI_130A" -> algos.RSI_MACD_PER(130, 30, 14, 25, 60, 99.5, 120, 101, 6, 20000);
            case "MACD_RSI_130B" -> algos.RSI_MACD_PER(130, 30, 28, 120, 60, 100, 120, 102, 6, 20000);
            case "MACD_RSI_130C" -> algos.RSI_MACD_PER(130, 30, 14, 25, 20, 0, 40, 0, 6, 20000);
            case "MACD_RSI_130D" -> algos.RSI_MACD_PER(130, 30, 28, 120, 20, 0, 40, 0, 6, 20000);
            case "MACD_RSI_127A" -> algos.RSI_MACD_PER(127, 30, 14, 25, 60, 99.5, 120, 101, 6, 20000);
            case "MACD_RSI_127B" -> algos.RSI_MACD_PER(127, 30, 28, 120, 60, 100, 120, 102, 6, 20000);
            case "MACD_RSI_127C" -> algos.RSI_MACD_PER(127, 30, 14, 25, 20, 0, 40, 0, 6, 20000);
            case "MACD_RSI_127D" -> algos.RSI_MACD_PER(127, 30, 28, 120, 20, 0, 40, 0, 6, 20000);
            case "MACD_RSI_125A" -> algos.RSI_MACD_PER(125, 30, 14, 25, 60, 99.5, 120, 101, 6, 20000);
            case "MACD_RSI_125B" -> algos.RSI_MACD_PER(125, 30, 28, 120, 60, 100, 120, 102, 6, 20000);
            case "MACD_RSI_125C" -> algos.RSI_MACD_PER(125, 30, 14, 25, 20, 0, 40, 0, 6, 20000);
            case "MACD_RSI_125D" -> algos.RSI_MACD_PER(125, 30, 28, 120, 20, 0, 40, 0, 6, 20000);
            case "MACD_RSI_122A" -> algos.RSI_MACD_PER(122, 30, 14, 25, 60, 99.5, 120, 101, 6, 20000);
            case "MACD_RSI_122B" -> algos.RSI_MACD_PER(122, 30, 28, 120, 60, 100, 120, 102, 6, 20000);
            case "MACD_RSI_122C" -> algos.RSI_MACD_PER(122, 30, 14, 25, 20, 0, 40, 0, 6, 20000);
            case "MACD_RSI_122D" -> algos.RSI_MACD_PER(122, 30, 28, 120, 20, 0, 40, 0, 6, 20000);
            case "40RSI_Fib03" -> algos.lowRSIanyFib(40, .03, 20000);
            case "30RSI_Fib01" -> algos.lowRSIanyFib(30, .01, 20000);
            case "30RSI_Fib02" -> algos.lowRSIanyFib(30, .02, 20000);
            case "30RSI_Fib03" -> algos.lowRSIanyFib(30, .03, 20000);
            case "28RSI_Fib01" -> algos.lowRSIanyFib(28, .01, 20000);
            case "28RSI_Fib02" -> algos.lowRSIanyFib(28, .02, 20000);
            case "28RSI_Fib03" -> algos.lowRSIanyFib(28, .03, 20000);
            case "25RSI_Fib01" -> algos.lowRSIanyFib(25, .01, 20000);
            case "25RSI_Fib02" -> algos.lowRSIanyFib(25, .02, 20000);
            case "25RSI_Fib03" -> algos.lowRSIanyFib(25, .03, 20000);
            default -> algos.dontBuy();
        };
    }
        ...
        if (BotRunner.isBacktest()) {
            ...
            if (coinValue > coinValuePeak) {
                ...
                if (coinPercentChange > 1) {                                             //trail stays at .5% until 1% gain
                    trailingPercent += (coinPercentChange - 1) * .066;                     //trail grows .1% for each addition 1% gain
